...
2. **Write clear, maintainable code** following the style guidelines below.
3. **Add or update unit tests** to cover your changes. Bug fixes should include a regression test that fails before the fix.
4. **Document public interfaces** with descriptive Python docstrings.
5. **Open a Pull Request** with a concise description of your changes, your motivation, and a note on any potential breaking changes.
6. **Update the [Changelog](CHANGELOG.md)** if your change modifies public API signatures or structural behaviors.
...
By submitting a contribution, you agree to license your work under the project's [Business Source License 1.1](LICENSE.md). If your code includes or derives from third-party assets, clearly state the origin and ensure it complies with our license constraints.
