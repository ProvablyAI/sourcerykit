...
from sourcerykit.db._intercepts import select_intercept_by_id, select_intercepts_by_action
...
async def create_query_record_for_intercept(
    ...
    if middleware_id is not None and collection_id is not None:
        ...
        raise SourceryKitBootstrapError("Provably bootstrap incomplete: middleware_id and collection_id are required")
