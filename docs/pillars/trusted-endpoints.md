...
For details on how the Interceptor blocks these calls, see [intercept](https://provably.ai/docs/pillars/intercept). To see how database tables fit into the wider architecture, see [architecture](https://provably.ai/docs/pillars/architecture).
